"""Ported by SnapDragon7410, Suggested by Cee Jay, Taken from PPE"""
import aria2p
...
@command(outgoing=True, pattern="^.amag(?: |$)(.*)")
...
@command(outgoing=True, pattern="^.ator(?: |$)(.*)")
...
@command(outgoing=True, pattern="^.aurl(?: |$)(.*)")
async def magnet_download(event):
...
@command(outgoing=True, pattern="^.aclear(?: |$)(.*)")
...
@command(outgoing=True, pattern="^.apause(?: |$)(.*)")
...
@command(outgoing=True, pattern="^.aresume(?: |$)(.*)")
...
@command(outgoing=True, pattern="^.ashow(?: |$)(.*)")
